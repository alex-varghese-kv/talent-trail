  ...
  return (
    <div className="main-page-wrapper">
          ...
          <div className="row">
            <div className="col-xxl-11 m-auto">
              ...
              <div className="video-post d-flex align-items-center justify-content-center mt-100 lg-mt-50 mb-50 lg-mb-30">
                <a className="fancybox rounded-circle video-icon tran3s text-center cursor-pointer">
      ...
      <section className="job-portal-intro">
        <div className="container">
          <div className="wrapper bottom-border top-border pt-100 lg-pt-80 md-pt-50 pb-65 md-pb-50">
            <div className="row align-items-center">
              ...
              <div className="col-lg-5">
                <ul className="btn-group style-none d-flex flex-wrap justify-content-center justify-content-lg-end">
                  ...
                  <li className="ms-2">
                    <a className="btn-four" href="register.html">
                      Post a job
                    </a>
                  </li>
                </ul>
