    ...
    <>
      <div className="inner-banner-one position-relative">
        ...
        <img
          ...
          src="../_next/static/media/shape_02.e6196842.svg"
        />
        <img
          alt="shape"
          loading="lazy"
          ...
          style={{ color: " transparent" }}
          src="../_next/static/media/shape_03.746a3d0c.svg"
        />
      </div>
            ...
            <div className="col-xxl-3 col-xl-4">
              <div className="job-company-info ms-xl-5 ms-xxl-0 lg-mt-50">
                <img
                  ...
                  style={{ color: " transparent" }}
                  src="../_next/media_22ab06.png?url=%2F_next%2Fstatic%2Fmedia%2Fmedia_22.142b36c3.png&amp;w=128&amp;q=75"
                />
