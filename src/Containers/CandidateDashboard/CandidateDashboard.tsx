                  ...
                  <div className="job-title d-flex align-items-center">
                    <a className="logo" href="job-details-v1/2.html">
                      <img
                        ...
                        className="lazy-img m-auto"
                        style={{ color: "transparent" }}
                        src="assets/media_2394bc.png?url=%2Fsrc%2Fassets%2Fstatic%2Fmedia%2Fmedia_23.20c2dd37.png&amp;w=128&amp;q=75"
                      />
                    </a>
                    <a
                      className="title fw-500 tran3s"
                  ...
                  <div className="job-title d-flex align-items-center">
                    <a className="logo" href="job-details-v1/3.html">
                      <img
                        ...
                        className="lazy-img m-auto"
                        style={{ color: "transparent" }}
                        src="assets/media_248d5d.png?url=%2Fsrc%2Fassets%2Fstatic%2Fmedia%2Fmedia_24.cfe1701c.png&amp;w=128&amp;q=75"
                      />
                    </a>
                    <a
                      className="title fw-500 tran3s"
                  ...
                  <div className="job-title d-flex align-items-center">
                    <a className="logo" href="job-details-v1/4.html">
                      <img
                        ...
                        className="lazy-img m-auto"
                        style={{ color: "transparent" }}
                        src="assets/media_2596e2.png?url=%2Fsrc%2Fassets%2Fstatic%2Fmedia%2Fmedia_25.7b6a766b.png&amp;w=128&amp;q=75"
                      />
                    </a>
                    <a
                      className="title fw-500 tran3s"
                  ...
                  <div className="job-title d-flex align-items-center">
                    <a className="logo" href="job-details-v1/5.html">
                      <img
                        ...
                        className="lazy-img m-auto"
                        style={{ color: "transparent" }}
                        src="assets/media_26d7e5.png?url=%2Fsrc%2Fassets%2Fstatic%2Fmedia%2Fmedia_26.98d48d45.png&amp;w=128&amp;q=75"
                      />
                    </a>
                    <a
                      className="title fw-500 tran3s"
                      ...
                      <div className="feedback-block-one color-two">
                        <div className="logo">
                          <img
                            ...
                            data-nimg="1"
                            style={{ color: "transparent" }}
                            src="assets/media_288f0b.png?url=%2Fsrc%2Fassets%2Fstatic%2Fmedia%2Fmedia_28.5c42659c.png&amp;w=384&amp;q=75"
                          />
                        </div>
                      ...
                      <div className="feedback-block-one color-two">
                        <div className="logo">
                          <img
                            ...
                            data-nimg="1"
                            style={{ color: "transparent" }}
                            src="assets/media_27e298.png?url=%2Fsrc%2Fassets%2Fstatic%2Fmedia%2Fmedia_27.493fb16e.png&amp;w=640&amp;q=75"
                          />
                        </div>
                        <blockquote className="fw-500 mt-50 md-mt-30 mb-50 md-mb-30 text-white">
                          “Seattle opera simplifies Performance planning with
                ...
                <div className="row align-items-center">
                  <div className="col-6">
                    <img
                      ...
                      style={{ color: "transparent" }}
                      src="assets/img_113078.jpg?url=%2Fsrc%2Fassets%2Fstatic%2Fmedia%2Fimg_11.9a9b27b5.jpg&amp;w=640&amp;q=75"
                    />
                  </div>
                  <div className="col-6">
                    <img
                      ...
                      style={{ color: "transparent" }}
                      src="assets/img_12babb.jpg?url=%2Fsrc%2Fassets%2Fstatic%2Fmedia%2Fimg_12.02e73ce9.jpg&amp;w=640&amp;q=75"
                    />
                    <img
                      alt="image"
                      loading="lazy"
                      ...
                      style={{ color: "transparent" }}
                      src="assets/img_131927.jpg?url=%2Fsrc%2Fassets%2Fstatic%2Fmedia%2Fimg_13.3ddabcd5.jpg&amp;w=640&amp;q=75"
                    />
                  </div>
                </div>
                <img
                  ...
                  style={{ color: "transparent" }}
                  src="assets/media/shape_06.269d8f2d.svg"
                />
                <img
                  alt="shape"
                  loading="lazy"
                  ...
                  style={{ color: "transparent" }}
                  src="assets/media/shape_21.e6dcf307.svg"
                />
              </div>
            </div>
          </div>
